...
int main(size_t argc, const char ** argv) {
    ...
    CL::chem::xyz<double> mex("mex-B2-A2.xyz", true);
    ...
    for (int64_t j = -Nh; j <= Nh; j++) {
        ...
        ofs_l << std::setw(25) << std::scientific << std::setprecision(15) << energy[2].item<double>() << '\n';
        ofs_u << std::setw(25) << std::scientific << std::setprecision(15) << energy[3].item<double>() << '\n';
    }
