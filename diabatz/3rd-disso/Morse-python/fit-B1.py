...
def bl2features(NH1: np.ndarray, NH2: np.ndarray) -> np.ndarray:
    ...
    # # 4+ order Morse
    # features[:,  9] = morse_plus  * morse_plus  * morse_plus  * morse_plus  * morse_plus
    # features[:, 10] = morse_minus * morse_minus * morse_plus  * morse_plus  * morse_plus
    # features[:, 11] = morse_minus * morse_minus * morse_minus * morse_minus * morse_plus
    # features[:, 12] = morse_plus  * morse_plus  * morse_plus  * morse_plus  * morse_plus  * morse_plus
    # features[:, 13] = morse_minus * morse_minus * morse_plus  * morse_plus  * morse_plus  * morse_plus
    # features[:, 14] = morse_minus * morse_minus * morse_minus * morse_minus * morse_plus  * morse_plus
    # features[:, 15] = morse_minus * morse_minus * morse_minus * morse_minus * morse_minus * morse_minus
    return features
...
if __name__ == "__main__":
    ...
    y = np.array(data[" energy B1 / Hartree"]) + 285.9453200579

    X = bl2features(NH1, NH2)
    XT = X.T
    Hessian = np.matmul(XT, X)
    # for i in range(1, Hessian.shape[0]):
