...
if __name__ == "__main__":
    ...
    r[(atom1 - 1) * 3] = 0.0
    r[(atom2 - 1) * 3] = 0.0
    r[(atom1 - 1) * 3 + 1] = -(abs(r[(atom1 - 1) * 3 + 1]) + abs(r[(atom2 - 1) * 3 + 1])) / 2.0
    r[(atom2 - 1) * 3 + 1] = -r[(atom1 - 1) * 3 + 1]
    r[(atom1 - 1) * 3 + 2] = (r[(atom1 - 1) * 3 + 2] + r[(atom2 - 1) * 3 + 2]) / 2.0
